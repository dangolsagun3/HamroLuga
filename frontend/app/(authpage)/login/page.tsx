      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome To HamroLuga</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="contact number" className="block text-sm font-medium text-black mb-1">
                Contact Number
              </label>
              <input
                id="contact number"
